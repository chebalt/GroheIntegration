"""
Fixtures for data-loader sync tests (sync_product_index.py).
...
tests have already completed by the time pytest reaches tests/data-loader/sync/ (alphabetical order).
"""
