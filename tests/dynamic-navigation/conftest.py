"""
dynamic-navigation — NavigationApi conftest.
...
Infrastructure required: make infra-dynamic-navigation-up
...
def _wait_for_navigation_api(timeout: int = 180) -> None:
    ...
    raise RuntimeError(
        ...
        "Run 'make infra-dynamic-navigation-up' and wait for the containers to start."
    )
